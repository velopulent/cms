...
export const Route = createFileRoute("/_admin/sites/$siteId/content-types")({
...
function ContentTypesPage() {
  ...
  const deleteMutation = useMutation({
    mutationFn: (slug: string) => deleteContentType(siteId, slug),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["content-types", siteId] });
                        ...
                        >
                          ...
                          <DialogContent className="max-h-[80vh] overflow-y-auto sm:max-w-lg">
                            ...
                            <ContentTypeForm
                              initialData={ct}
                              onSubmit={(data) => {
                                updateContentType(siteId, ct.slug, {
                                  name: data.name,
                                  slug: data.slug,
