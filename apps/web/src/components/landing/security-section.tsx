        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              100% open source means you control your data. Role-based access control for teams. Complete audit history of all changes.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-100 overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Your data</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">100%</span>
                <span className="block text-muted-foreground mt-2">Under your control</span>
              </div>
            </div>
