...
CREATE INDEX idx_backups_storage_profile ON backups(storage_profile_id);
CREATE INDEX idx_backup_schedules_storage_profile ON backup_schedules(storage_profile_id);
ALTER TABLE backups ADD CONSTRAINT fk_backups_storage_profile FOREIGN KEY (storage_profile_id) REFERENCES storage_profiles(id) ON DELETE RESTRICT;
ALTER TABLE backup_schedules ADD CONSTRAINT fk_backup_schedules_storage_profile FOREIGN KEY (storage_profile_id) REFERENCES storage_profiles(id) ON DELETE RESTRICT;
