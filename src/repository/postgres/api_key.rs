...
impl ApiKeyRepository for PostgresApiKeyRepository {
    ...
    async fn create(
        ...
        sqlx::query(
            "INSERT INTO api_keys (id, site_id, name, key_hash, key_prefix, permissions) VALUES ($1, $2, $3, $4, $5, $6)",
        )
        .bind(id)
        .bind(site_id)
        .bind(name)
    ...
    async fn find_by_prefix(
        ...
        let result = sqlx::query_as::<_, (String, String, String, Option<String>, String)>(
            "SELECT id, site_id, key_hash, expires_at, permissions FROM api_keys WHERE key_prefix = $1",
        )
        .bind(prefix)
        .fetch_all(&self.pool)
        .await?;
